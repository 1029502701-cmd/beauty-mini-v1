...
interface KOL { id: string; name: string; avatar?: string; intro: string; }
interface CreatorPlaceholderProps { kols: KOL[]; }
        ...
        <div className="kol-list">
          {kols.slice(0, 2).map((kol, index) => (
            <div key={kol.id} className="kol-item">
              ...
              {kol.avatar && <div className="kol-avatar"><img src={kol.avatar} alt={kol.name} /></div>}
