  ...
  useEffect(() => {
    ...
    const timeout = setTimeout(async () => {
      try {
        ...
        if (msg.includes("DAILY_LIMIT") || msg.includes("次数已用完") || msg.includes("次数已满")) setError("次数已用完，请明天再试");
        else if (msg.includes("INSUFFICIENT_TOKEN") || msg.includes("Token不足")) setError("Token不足，请解锁后继续");
        else setError(msg);
      }
