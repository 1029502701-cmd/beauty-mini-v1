...
/** Result of checking report access in report_access table. */
...
/** Result of granting report access. */
...
"""
path = os.path.join(base, 'beauty-api-pages', 'modules', 'beauty-ai', 'permission', 'report-access-service.ts')
with open(path, 'w', encoding='utf-8') as f:
    f.write(content)
print('Wrote report-access-service.ts')
